...
class LibraryItem extends EditorialContentEntityBase implements LibraryItemInterface {
  ...
  */
  public function createDuplicate() {
    ...
    // Loop over entity fields and duplicate paragraph reference.
    foreach ($duplicate->getFields() as $fieldItemList) {
      if ($fieldItemList instanceof \Drupal\entity_reference_revisions\EntityReferenceRevisionsFieldItemList && $fieldItemList->getSetting('target_type') === 'paragraph') {
