...
class miniorange_saml_sp_registration{

	public static function miniorange_saml_register_popup($payment_plan){
		$status = \Drupal::config('miniorange_saml.settings')->get('miniorange_saml_status');
                            ...
                            <form name="f" method="post" action="" id="mo_register">
                                <div>
                                    ...
                                    <div class="modal-footer">
                                        <a type="button" class="btn btn-default" href="<?php echo $requestUrl ?>" style="float:left;" >Close</a>
                                        ...
                                        <br>
                                        <h6 style="text-align:center;">In case of any queries or issues, <br> please <a href="mailto:<?php echo MiniorangeSAMLConstants::SUPPORT_EMAIL; ?>"><strong>contact us</strong>.</a> </h6>
                                    </div>
                                    </p>
                                </div>
                            </form>
            ...
            <div class="modal fade" id="myModal" role="dialog" style="background: rgba(0,0,0,0.1);">
                <div class="modal-dialog" style="width: 500px;">
                    <div class="modal-content popup" style="border-radius: 20px;">
                            ...
                            <p class="popup-header" style="color: red;font-size: 11px;">An error occured while sending OTP. Please try after some time.</p>
                            <?php }elseif ($resend_otp == true){ ?>
                            <h4 class="popup-header">An OTP has been resend to <?php echo $admin_email ?></h4>
        ...
        <html>
            ...
            <body>
                <script type="text/javascript">
                   ...
                   var isPopupSuccess = window.open("<?php echo $redirectUrl; ?>","_blank" );
