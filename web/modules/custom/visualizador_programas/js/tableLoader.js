(function ($, Drupal) {
  'use strict';
  Drupal.behaviors.tableLoader = {
    attach: function (context, settings) {
      $('#tabla_upb').once().each(function() {
        $(document).ready(function() {
          ...
          function activaBarrasProgreso() {
            $('.barra_progreso').each(function( index ) {
              var progreso = $(this).data('parcial');
          ...
          $.ajax({
            ...
            success : function(data) {
              var procesos = [];
              data.procesos.data.forEach((item, index) => {
                var barraProgreso = '<div class="barra_progreso" data-parcial="'+item['actividadesFinalizadas']+'" data-total="'+item['totalActividades']+'">'+'</div>'
                var datos = item['actividadesFinalizadas']+'/'+item['totalActividades']
                item['barra'] = barraProgreso;
                item['datos'] = datos;
                procesos.push(item);
              });
              $('#tabla_upb').DataTable({
                ...
                drawCallback: function () {
                  activaBarrasProgreso();
                },
                responsive: true,
                paging: false,
                columns: [
                  { title: "Procesos", data: "nombre" },
                  { title: "Progreso", data: 'barra' },
                  { title: "Actividades", data: 'datos' },
                ],
              });
            }
          });
